...
class IconTextTab(QWidget):
    ...
    def __init__(self, parent):
        ...
        layout.addWidget(QLabel("Icon Size:"), 2, 0)
        layout.addWidget(self.icon_size, 2, 1, 1, 5)
        layout.addItem(QSpacerItem(30, 30), 3, 0)
        layout.addWidget(QLabel("Text:"), 4, 0)
        layout.addWidget(self.text_input, 4, 1, 1, 5)
        layout.addWidget(QLabel("Font:"), 5, 0)
        layout.addWidget(self.fonts, 5, 1, 1, 5)
        layout.addWidget(QLabel("Font Size:"), 6, 0)
        layout.addWidget(self.font_size, 6, 1, 1, 5)
        layout.addItem(QSpacerItem(30, 30), 7, 0)
        layout.addWidget(self.create_button, 8, 4)
        layout.addWidget(self.print_button, 8, 5)
    ...
    def on_create_clicked(self):
        ...
        self.temp_output_path = create_icon_text_image(width, height, text, font_size, font_family, icon_path, icon_size)
